 ...
 */
class Invoice extends Order\Pdf\Invoice
{
        ...
        if ($order->getIsVirtual()) {
            ...
            if ($deliveryGeneralEnabled) {
                ...
                if ($currentOrder) {
                    ...
                    if (in_array(self::SALES_ORDER_PRINTINVOICE, explode(',', $deliveryDateInclude)) && $deliveryDate) {
                        $page->drawText(__('Delivery Date : '), 285, $this->y, 'UTF-8');
                        $page->drawText($deliveryDate, 350, $this->y, 'UTF-8');
                        $this->y -= 15;
                    }
                    if (in_array(self::SALES_ORDER_PRINTINVOICE, explode(',', $deliveryTimeInclude)) && $deliveryTimeEnabled && $deliveryTime) {
                        $page->drawText(__('Delivery Time : '), 285, $this->y, 'UTF-8');
                        $page->drawText($deliveryTime, 355, $this->y, 'UTF-8');
                        $this->y -= 15;
                    }
                    if (in_array(self::SALES_ORDER_PRINTINVOICE, explode(',', $deliveryCommentInclude)) && $deliveryCommentEnabled && $deliveryComment) {
